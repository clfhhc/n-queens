...
window.findNRooksSolution = function(n) {
  //input: integer (number of pieces and size of the board)
...
window.findNQueensSolutionSet = function(n) {
  // input = integer (size of board) 
  // output = array of solution Boards for N-Queens
  if (n === 0 || n === 2 || n === 3) {
    return [];
  }
  var potentialSolutions = findNRooksSolutionSet(n);
  // Using filter method on potentialSolutions, check if there are any Major / Minor diagonal conflicts
